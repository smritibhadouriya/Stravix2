  ...
  return (
    <div className="min-h-screen bg-[#F16D34]/5 text-black">
      ...
      <div className="max-w-7xl mx-auto px-1 lg:px-8 py-10 flex flex-col lg:flex-row-reverse gap-10">
        <SEO
        title={`${study.title} | Stravix Media Blog`}
        description={study.description}
          keywords={`Stravix Media, Blog, ${study.service}, ${study.title}`}
          canonicalUrl={`https://Stravix.media/blog/${toSlug(study.title)}`}
          ogImage={study.banner}
